...
void HGCalDetector::ConstructCassettes(){
  ...
  siBox = new G4Box("siBox", xSi, ySi, zSi);
  logicalSi = new G4LogicalVolume(siBox, Si, "logicalSiBox");
  
  new G4PVPlacement(0, G4ThreeVector(0., 0., -8.0175*mm), logicalSi, "physSi", logicalCassette, false, 0, true);
  ...
  new G4PVPlacement(0, G4ThreeVector(0., 0., 1.9225*mm), logicalSi, "physSi", logicalCassette, false, 1, true);
