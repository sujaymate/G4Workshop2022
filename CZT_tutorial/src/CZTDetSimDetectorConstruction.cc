...
// Include Necessary geometry classes


// Includes for material and unit definitions


// Includes for geometry shape header files


// Include for detector construction headers
...
G4VPhysicalVolume* CZTDetSimDetectorConstruction::Construct()
{
    ...
    // Set visualisation attributes for CZT wafer

    // CADMesh import (problem 5)
